...
.user-icon img {
    ...
    object-fit: cover;  /* ليتناسب الصورة مع الدائرة */
    border: 2px solid #fff; /* اختياري: إطار أبيض */
    transition: transform 0.2s; /* حركة بسيطة عند hover */
}

.user-icon img:hover {
    transform: scale(1.1); /* تكبير خفيف عند المرور */
}
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{ route('user.courses.index') }}" class="nav-item nav-link">Home</a>
                <a href="about.html" class="nav-item nav-link">About</a>
                <a href="{{ route('user.courses.course') }}" class="nav-item nav-link active">Courses</a>
                ...
                <div class="col-lg-10 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-center">
                            <li class="breadcrumb-item"><a class="text-white" href="{{ route('user.courses.index') }}">Home</a></li>
