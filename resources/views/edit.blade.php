          ...
          <div class="row">
            <div class="col-md-12">
              ...
              @if ($errors->any())
                ...
                @endif
        <div class="card-body">
            <form class="form-horizontal" action="{{route('user.update',$course->id)}}" enctype="multipart/form-data" method="post">
              @csrf
             @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input  value="{{$course->name}}" type="text" class="form-control" id="name" placeholder="First Name Here"
                                name="name" />
                        </div>
                    </div>
