            ...
            <div class="card">
                ...
                <form class="form-horizontal" action="{{ route('user.store') }}" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-sm-3 text-end control-label col-form-label">Course Name</label>
                        <div class="col-sm-9">
                    ...
                    <!-- Instructor -->
                    <div class="form-group row">
                        <label for="instructor_id" class="col-sm-3 text-end control-label col-form-label">Instructor</label>
                        <div class="col-sm-9">
